...
(blood levels of neurofilament light chain, measured at time of diagnosis),
we visualize four selected patients:
```{r score_over_time}
...
This enables prediction of disease progression, increasing statistical power
in clinical ALS trials. More details can be found in our manuscript:
